...
console.log("PROGRAM: [54] - [DOM ELEMENT CREATION AND REMOVAL - CREATEELEMENT, APPENDCHILD, REMOVE  ] ");
...
document.addEventListener('DOMContentLoaded', function() { 
    ...
    if (addBtn && dynamicList) { 
        ...
        const sampleItems = ['Learn JavaScript', 'Build a project', 'Master DOM']; 
        sampleItems.forEach(text => { 
 
            dynamicList.appendChild(createListItem(text)); 
        }); 
        updateItemCount(); 
    } 
