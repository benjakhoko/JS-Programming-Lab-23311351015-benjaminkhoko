...
console.log("No flags:", flagsDemo.match(/apple/));      
console.log("i flag:", flagsDemo.match(/apple/i));       
console.log("g flag:", flagsDemo.match(/apple/g));       
console.log("gi flag:", flagsDemo.match(/apple/gi));     
['APPLE'] 
console.log("\n--- Character Classes ---"); 
// \d - digits 
// ['apple'] 
...
console.log("Words in 'hello_world 123!':", 'hello_world 123!'.match(/\w+/g)); 
// \s - whitespace 
...
// Date (YYYY-MM-DD) 
date: (value) => /^\d{4}-(0[1-9]|1[0-2])-(0[19]|[12]\d|3[01])$/.test(value), 
// Hex color 
